...
public class DataLoader {
	...
	public static Map<String, Item> loadItemsSQL(Map<String, Person> personsMap) {
		...
		try {
			...
			String query = "SELECT si.saleitemId, i.code, i.type, i.name, i.baseCost, "
					+ "si.beginningLeaseDate, si.endingLeaseDate, " + "si.serviceHours, p.uuid AS employeeID, "
					+ "si.vpNumber, si.vpDays, "
